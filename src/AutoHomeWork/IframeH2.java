...
//		driver.switchTo().frame(ifa);
         ...
         WebElement swton = driver.findElement(By.xpath("//button[text()='Turn on the light']"));
         swton.click();
         
        // driver.switchTo().defaultContent();
         
         WebElement swoff = driver.findElement(By.xpath("//button[text()='Turn off the light']"));
         swoff.click();
